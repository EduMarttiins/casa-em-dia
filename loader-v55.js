(async()=>{
  try{
    const response=await fetch('./index.html?raw=v61&ts='+Date.now(),{cache:'no-store'});
    if(!response.ok)throw new Error('Falha ao carregar a base do aplicativo');
    let html=await response.text();

    /* Versão 61: mantém escrita, contexto e Michaelis, adicionando atualização manual com versão visível. */
    const mcqIds=[];
    ...
    html=html.replace(/<meta name="app-version" content="[^"]*">/,'<meta name="app-version" content="61">');
    html=html.replace(/\.\/manifest\.webmanifest(?:\?[^"']*)?/g,'./manifest.webmanifest?v=61');
    html=html.replace(/\.\/icons\/lousa-icon\.svg(?:\?[^"']*)?/g,'./icons/lousa-icon-512.png?v=61');
    ...
    const css='\n<link rel="stylesheet" href="./v37.css?v=61">\n<link rel="stylesheet" href="./pwa-v39.css?v=61">\n';
    html=html.replace('</head>',css+'</head>');
    const scripts='\n<scr'+'ipt src="./v37.js?v=61"></scr'+'ipt>\n<scr'+'ipt src="./v41.js?v=61"></scr'+'ipt>\n<scr'+'ipt src="./v50.js?v=61"></scr'+'ipt>\n<scr'+'ipt src="./pwa-v52.js?v=61"></scr'+'ipt>\n<scr'+'ipt src="./v54.js?v=61"></scr'+'ipt>\n<scr'+'ipt src="./v55.js?v=61"></scr'+'ipt>\n<scr'+'ipt src="./v56.js?v=61"></scr'+'ipt>\n<scr'+'ipt src="./v57.js?v=61"></scr'+'ipt>\n<scr'+'ipt src="./v58.js?v=61"></scr'+'ipt>\n<scr'+'ipt src="./v59.js?v=61"></scr'+'ipt>\n<scr'+'ipt src="./v60.js?v=61"></scr'+'ipt>\n<scr'+'ipt src="./v55-auto-update.js?v=61"></scr'+'ipt>\n';
