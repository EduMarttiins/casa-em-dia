(async()=>{
  try{
    const response=await fetch('./index.html?raw=v54&ts='+Date.now(),{cache:'no-store'});
    ...
    html=html.replace(/<meta name="app-version" content="[^"]*">/,'<meta name="app-version" content="54">');
    html=html.replace(/\.\/manifest\.webmanifest(?:\?[^"']*)?/g,'./manifest.webmanifest?v=54');
    html=html.replace(/\.\/icons\/lousa-icon\.svg(?:\?[^"']*)?/g,'./icons/lousa-icon-512.png?v=54');
    html=html.replace(/type="image\/svg\+xml"/g,'type="image/png"');
    html=html.replace(/<link rel="stylesheet" href="\.\/(?:v3[5-9]|v4[0-9]|v5[0-4]|pwa-v3[9]|pwa-v4[0-9]|pwa-v5[0-4])\.css\?v=\d+">\s*/g,'');
    html=html.replace(/<script src="\.\/(?:v3[5-9]|v4[0-9]|v5[0-4]|pwa-v3[9]|pwa-v4[0-9]|pwa-v5[0-4])\.js\?v=\d+"(?: defer)?><\/script>\s*/g,'');
    const css='\n<link rel="stylesheet" href="./v37.css?v=54">\n<link rel="stylesheet" href="./pwa-v39.css?v=54">\n';
    html=html.replace('</head>',css+'</head>');
    const scripts='\n<scr'+'ipt src="./v37.js?v=54"></scr'+'ipt>\n<scr'+'ipt src="./v41.js?v=54"></scr'+'ipt>\n<scr'+'ipt src="./v50.js?v=54"></scr'+'ipt>\n<scr'+'ipt src="./pwa-v52.js?v=54"></scr'+'ipt>\n<scr'+'ipt src="./v54.js?v=54"></scr'+'ipt>\n<scr'+'ipt src="./v54-auto-update.js?v=54"></scr'+'ipt>\n';
